...
{
    /**
     * @var integer Количество галерей на страницу (тумбы в категориях, или в новых, например).
     */
    ...
    /**
     * @var boolean Относительная директория хранилища фотографий.
     */
    public $storage_directory = '/storage/photos';
    ...
    public function rules()
    {
        return [
            ...
            [['storage_directory'], 'trim'],
            [['storage_directory'], 'filter', 'filter' => function ($value) {
            ...
            [['storage_directory'], 'default', 'value' => '/storage/photos'],
        ];
    }
