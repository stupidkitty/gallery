...
$this->params['subtitle'] = Yii::t('gallery', 'categories');
        ...
        <div class="box box-success">
            ...
            <div class="box-footer clearfix">
			    <div class="form-group">
					<?= Html::submitButton('<i class="fa fa-fw fa-plus text-green"></i>' . Yii::t('gallery', 'add'), ['class' => 'btn btn-default', 'form' => 'category-form']) ?>
				</div>
			</div>
