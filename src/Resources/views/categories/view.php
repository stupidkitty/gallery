...
$this->params['breadcrumbs'][] = Yii::t('gallery', 'info');
...
<div class="row">
	...
	<div class="col-md-8">
			...
			<div class="box-header with-border">
				...
				<div class="box-tools pull-right">
					<div class="btn-group">
						...
						<?= Html::a('<i class="fa fa-fw fa-edit text-blue"></i>' . Yii::t('gallery', 'edit'), ['update', 'id' => $category->getId()], ['class' => 'btn btn-default btn-sm', 'title' => 'Редактировать категории']) ?>
        ...
        <div class="box box-default">
			<div class="box-header with-border">
				<i class="fa fa-area-chart"></i><h3 class="box-title">Популярность категории за последниe 30 дней, в %</h3>
                <div class="box-tools pull-right">
...
$this->registerJsVar('chartPoints', array_column($stats, 'popularity'));
