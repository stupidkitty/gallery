...
<div class="row">
    ...
    <div class="col-md-6">
        <div class="box box-default">
        	<div class="box-header with-border">
        		<h3 class="box-title">Статистика по галереям</h3>
            </div>

            <div class="box-body pad">
                <div class="row">
                    <div class="col-md-4">
                    	Всего галерей: <b><?= $galleryReport->getTotalGalleries() ?></b><br><br>
                        <h5>По статусам</h5>
                        Активные: <b><?= $galleryReport->getActiveGalleries() ?></b><br>
                        Выключеные: <b><?= $galleryReport->getDisabledGalleries() ?></b><br>
                        На модерации: <b><?= $galleryReport->getModerateGalleries() ?></b><br>
                        На удаление: <b><?= $galleryReport->getDeletedGalleries() ?></b><br>
                        В автопостинге: <b><?= $galleryReport->getAutopostingGalleries() ?></b><br>
        	        </div>
                    <div class="col-md-4">
                        Всего категорий: <b><?= $galleryReport->getTotalCategories() ?></b><br><br>
                        <h5>По статусам</h5>
                        Активные: <b><?= $galleryReport->getEnabledCategories() ?></b><br>
                        Выключеные: <b><?= $galleryReport->getDisabledCategories() ?></b><br>
        	        </div>
                    <div class="col-md-4">
                        Всего изображений: <b><?= $galleryReport->getTotalImages() ?></b><br><br>
        	        </div>
        	    </div>
        	</div>
