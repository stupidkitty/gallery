		...
		<?php $activeForm = ActiveForm::begin([
			...
			<div class="nav-tabs-custom">
				<ul class="nav nav-tabs">
                    ...
                    <li class=""><a href="#upload-storage" data-toggle="tab" aria-expanded="false">Хранилище</a></li>
				</ul>
				...
				<div class="tab-content">
					...
					<div class="tab-pane" id="related">
                        ...
                        <div class="form-group">
							<label><?= Html::activeCheckbox($form, 'related_enable', ['label' => false]) ?> <span>Включить отображение виджета "Похожие галереи"</span></label>
                    ...
                    <div class="tab-pane" id="upload-storage">
                        <?= $activeForm->field($form, 'storage_directory')
					    		->textInput()
					    		->label('Относительный путь в хранилище фотографий')
                                ->hint('Директрия, в которой будет организовано основное хранилище сайта. Используется относительный путь, т.к. хранилище фотографий может находится не на текущем сервере (настраивается в конфигурации модуля).
                                        Если используется локальное хранилище, то директория будет относительно базовой директории сайт. Например /var/www/public_html/example.com/RELATIVE_PATH
                                        <br><span class="text-red">Пока не работает</span>')
					    ?>
					</div>
				</div>
